#Librerias para codigos comentados
"""from django.http import HttpResponse
from django.shortcuts import get_object_or_404
from rest_framework.decorators import api_view
from rest_framework.generics import ListCreateAPIView, RetrieveUpdateDestroyAPIView
from rest_framework.mixins import ListModelMixin, CreateModelMixin
from rest_framework.views import APIView #Para el class base view"""
...
#Api_View Class delacarción de los api_view en formato de clase class utilizando la clase modelviewSet
...
class CollectionViewSet(ModelViewSet):
    ...
    def destroy(self, request, *args, **kwargs):
        if Collection.objects.annotate(products_count=Count('products')).get(pk=kwargs['pk']).products_count>0:
            return Response({'Error':'Collection can not be deleted because it is associated with a product.'},status=status.HTTP_405_METHOD_NOT_ALLOWED)
        return super().destroy(request, *args, **kwargs)
...
class ReviewViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        return Review.objects.filter(pk=self.kwargs['product_pk'])
...
#Lógica para filtrar manualmente
"""
    def get_queryset(self):
...
#Api_View Class delacarción de los api_view en formato de clase class utilizando la clase generics
"""
class ProductList(ListCreateAPIView):
    
    #Cambiar solo los atributos
...
#Api_View Class delacarción de los api_view en formato de clase class
"""
...
#Api_View Function delacarción de los api_view en formato de función def
"""
@api_view(['GET', 'POST'])
